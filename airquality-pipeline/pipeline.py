...
preprocess_step = ProcessingStep(
    ...
    outputs=[
        ...
        ProcessingOutput(output_name="preprocess-model", source="/opt/ml/processing/output/model"),
    ],
...
train_step = TrainingStep(
    ...
    inputs={
        ...
        "preprocessing": TrainingInput(
            s3_data=preprocess_step.properties.ProcessingOutputConfig.Outputs["preprocess-model"].S3Output.S3Uri
        ),
    },
)
...
# --------------------------------------------------
# Model object (for registry + deployment)
# --------------------------------------------------
...
# --------------------------------------------------
# Endpoint Deployment Step (AUTO UPDATE)
# --------------------------------------------------
...
pipeline = Pipeline(
    ...
    parameters=[input_data, accuracy_threshold, endpoint_name],
    steps=[
        preprocess_step,
        train_step,
        evaluation_step,

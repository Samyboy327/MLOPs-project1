...
def main():
    ...
    X_train_scaled.to_csv(os.path.join(train_dir, "X_train.csv"), index=False)
    y_train.to_csv(os.path.join(train_dir, "y_train.csv"), index=False)

    X_val_scaled.to_csv(os.path.join(val_dir, "X_val.csv"), index=False)
    y_val.to_csv(os.path.join(val_dir, "y_val.csv"), index=False)

    X_test_scaled.to_csv(os.path.join(test_dir, "X_test.csv"), index=False)
    ...
    joblib.dump(X.columns.tolist(), os.path.join(model_dir, "features.joblib"))
